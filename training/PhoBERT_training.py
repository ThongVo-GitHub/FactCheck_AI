...
train_data = pd.read_csv("D:/Code_cuaThong/GPPM_2025/train_data.csv")
test_data = pd.read_csv("D:/Code_cuaThong/GPPM_2025/test_data.csv")
dev_data = pd.read_csv("D:/Code_cuaThong/GPPM_2025/dev_data.csv")
...
torch.save({
    ...
    "num_classes": 3  # nếu có 3 nhãn (True / False / NEI)
}, "checkpoints/phobert_best.pth")

tokenizer.save_pretrained("checkpoints/tokenizer")

print("✅ Model và tokenizer đã được lưu vào thư mục checkpoints/")
